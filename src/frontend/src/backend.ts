...
import type { ContactSubmission as _ContactSubmission, SubmitContactRequest as _SubmitContactRequest, SubmitContactResult as _SubmitContactResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitContact(arg0: SubmitContactRequest): Promise<SubmitContactResult> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContact(to_candid_SubmitContactRequest_n5(this._uploadFile, this._downloadFile, arg0));
                return from_candid_SubmitContactResult_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_SubmitContactResult_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubmitContactResult): SubmitContactResult {
...
function to_candid_SubmitContactRequest_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubmitContactRequest): _SubmitContactRequest {
